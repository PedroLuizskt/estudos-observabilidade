...
NOTA DA AULA 3: o código aqui continua praticamente idêntico ao da
aula 1. Toda a observabilidade (métricas na aula 2, traces na aula 3)
é injetada **de fora**, via `opentelemetry-instrument` (ver Dockerfile).

Esse é exatamente o ponto didático da instrumentação automática:
um serviço de produção pode ganhar métricas HTTP padronizadas E
spans com propagação de contexto W3C sem mexer em uma linha do
código de aplicação — basta alterar variáveis de ambiente.
"""
